...
<label class="checkbox" style=""><input type="checkbox" name="check_field" class="chh" />&nbsp; I have read and agree to the <a href="<?php echo $this->webroot.'pages/privacy';?>" target="_blank">Privacy Policy</a> and <a href="<?php echo $this->webroot.'pages/terms';?>" target="_blank">Terms & Conditions</a>.
</label>
