    ...
    <div style="width: 38%; float: left;">
        ...
        foreach ($strain['StrainImage'] as $g) {
            ...
            <a class="fancybox" rel="group"
               href="<?php echo $this->webroot; ?>images/strains/<?php echo $g['image']; ?>" style="valign:top;"><img
                    style="valign:top;" src="<?php echo $this->webroot; ?>images/strains/<?php echo $g['image']; ?>"
                    width="120px"/></a>
        <?php
        }
        ?>
        ...
        if ($arr) {
            foreach ($arr as $e) {
                ...
                <div class="eff">
                    ...
                    <div class="left ratewrap"><img src="<?php echo $this->webroot; ?>Capture.PNG"
                                                    style="width: <?php echo $length; ?>%;height:25px;position: absolute; text-align: center;left:0;"/><em><?php echo number_format($rate, 2); ?>
                            /5</em></div>
                    <div class="clear"></div>
                </div>
            <?php
        ...
        <div class="">
            ...
            if ($scale) {
                ...
                <div class="eff">
                    ...
                    <div class="left ratewrap"><img src="<?php echo $this->webroot; ?>Capture.PNG"
                                                    style="width: <?php echo round($scale, 2); ?>%;height:25px;position: absolute;left:0;"/><em><?php echo round($scale / 20, 2); ?>
                            /5</em></div>
                    <div class="clear"></div>
                </div>
            <?php
            ...
            if ($strength) {
                ...
                <div class="eff">
                    ...
                    <div class="left ratewrap" style="width: 63%;background:#FFF;"><img
                            src="<?php echo $this->webroot; ?>Capture.PNG"
                            style="width: <?php echo round($strength, 2); ?>%;height:25px;position: absolute;left:0;"/><em><?php echo round($strength / 20, 2); ?>
                            /5</em></div>
                    <div class="clear"></div>
                </div>
            <?php
            ...
            if ($duration) {
                ...
                <div class="eff">
                    ...
                    <div class="left ratewrap" style="width: 63%;background:#FFF;"><img
                            src="<?php echo $this->webroot; ?>Capture.PNG"
                            style="width: <?php echo round($duration, 2); ?>%;height:25px;position: absolute;left:0;"/><em><?php echo round($duration / 20, 2); ?>
                            /5</em></div>
                    <div class="clear"></div>
                </div>
            <?php
...
<div class="print noprint">
    <center><a class="blue more" href="javascript:void(0)" onclick="window.print();">Print Report</a> <a
            href="javascript:void(0)" class="blue more" onclick="$('.invite').toggle();">Invite your friend</a> <a
            href="#" class="blue more">Share on Social Media</a></center>
</div>
